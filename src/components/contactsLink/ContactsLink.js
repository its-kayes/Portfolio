        ...
        <div className='mt-[-100px]'>
            <div className='flex w-4/6 justify-center'>
                <div className='flex mb-6'>
                    <i className='text-[#1EC08F] text-4xl font-bold ml-14'> Find Me </i> <i className='mt-3 ml-2 text-[#8892B0] font-semibold'>on the web! For contacting, I prefer mail.</i>
                    {/* <p>Find me on the web! For contacting, I prefer mail.</p> */}
                </div>
            </div>
