    ...
    return (
        <div>
            <div className='flex justify-between items-center text-white p-20'>
                <div className=''>
                    <div>
                        <h1 className='text-7xl font-bold font-mono text-white amiri'> Hello! </h1>
                        <h1 className='text-5xl font-bold font-mono text-white amiri'> This is Emrul Kayes </h1>
                        {/* <span> H </span> */}
                        <p className='pt-3 text-xl text-sky-200'><Typical
                        ...
                        <a href="resume.pdf" className='btn border-2 border-sky-300 normal-case hover:text-black hover:bg-sky-100' download> Download Resume <i class="fa-solid fa-download pl-2"></i> </a>
